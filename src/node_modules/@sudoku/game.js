...
import {initGameHistory} from'./stores/treeHistoryManager.js';
 ...
 *
 * @param {string} input - url or sencode
 */
export function startCustom(input) {
	const gridData = PuzzleParser.parse(input);
	difficulty.setCustom();
	grid.setWholeGrid(gridData);
	cursor.reset();
	timer.reset();
	hints.reset();

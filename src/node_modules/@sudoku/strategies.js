...
class RecommendationEngine {
    ...
    _countSolvedCells(context) {
        ...
        for (let r = 0; r < SUDOKU_SIZE; r++) {
            for (let c = 0; c < SUDOKU_SIZE; c++) {
                // If the cell is filled or has been reduced to a single candidate, count it as solved.
    ...
    recommend(grid) {
        ...
        // Calculate initial metrics using the solved-cell counting method
        ...
        for (const profile of this.strategiesProfile) {
            ...
            if (isEffective) {
                // Calculate metrics after strategy execution
                ...
                // Scoring Formula: 
                // Prioritize solving cells (weight: 100) significantly over eliminating candidates (weight: 1).
                // Subtract difficulty cost to break ties in favor of simpler strategies.
        ...
        // Generate dynamic reason text based on execution details

...
/**
 * Resets hint-related UI states, clearing highlights and trial markers.
 */
...
/**
 * Implements the core business logic for digit input, handling notes, and history branching.
 * @param {number} num - The digit to insert (0 for clearing).
 * @param {Object} context - An object containing reactive store values and store instances.
 * @param {boolean} context.$keyboardDisabled - Current disabled state of the keyboard.
 * @param {boolean} context.$isHintActive - Current active state of the hint mode.
 * @param {number[]} context.$hintCandidates - Active hint digits.
 * @param {boolean} context.$notes - Current state of notes mode.
 * @param {Object} context.$cursor - Current cursor position {x, y}.
 * @param {number[][]} context.$userGrid - Current board state.
 * @param {Object} context.userGrid - The grid store instance.
 * @param {Object} context.candidatesStore - The candidates/notes store instance.
 * @param {Object} context.historyTree - The history manager instance.
 * @param {boolean} context.isInBacktrackMode - Current backtrack mode status.
 */

...
export class TreeNode {
  ...
  constructor(historyNode, parent = null, backtrackable = false, infos = null) {
    /** Unique identifier of this tree node */
    this.id = Date.now().toString(36) + Math.random().toString(36).substr(2);

    /** The immutable history snapshot associated with this node */
    ...
    /** Whether this node is a valid backtracking point */
...
export class TreeHistoryManager {
  constructor() {
    /** Root node of the history tree */
    this.root = null;

    /** Current active node in the history tree */
